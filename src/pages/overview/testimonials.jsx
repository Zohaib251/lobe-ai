...
// const Testimonials = () => {
//   return (
//     <div className="bg-[#F2F3F5] py-16 overflow-x-auto">
//       <div className="flex justify-start lg:justify-center space-x-8 lg:space-x-8 mx-auto">
//         <a href="">
//           <div className="bg-[#FFFFFF] rounded-2xl shadow-lg p-6 w-60 text-gray-800 duration-300 transform transition-transform ease hover:scale-105 flex-shrink-0">
//             <div className="flex items-center mb-4">
//               <img
//                 src={image1}
//                 alt="Chris Cachor"
...
//             </div>
//             <p className="text-md text-[#333333]">
//               As soon as I used Lobe I was completely blown away. I don't have
//               to spend days trying to learn machine learning. Simply label some
//               images and boom, it really just works.
//             </p>
//             <div className="mt-10">
//               <h3 className="text-md text-[#333333] font-bold">Chris Cachor</h3>
...
//             </div>
//             <p className="text-md text-[#333333]">
//               We’ve been using Lobe to quickly process previously untapped
//               sources of data so that we can improve our models of
//               nature-dependent tourism to promote better decision-making in our
//               oceans.
//             </p>
//             <div className="mt-10">
//               <h3 className="text-md text-[#333333] font-bold">
...
//             <p className="text-md text-[#333333]">
//               Lobe is so easy and takes so much of the complicated stuff out of
//               machine learning. Even my kid was begging me to sit in front of
//               the computer and categorize my bees for me.
//             </p>
//             <div className="mt-10">
//               <h3 className="text-md text-[#333333] font-bold">Sean Cusack</h3>
//               <p className="text-md font-semibold text-[#767676]">Beekeeper</p>
